...
#Multivariate plots
#CSTI multi Plot
CSTI <- read.delim(file.path("CSTI_multi_18.txt"))
...
#CSTII multi Plot
CSTII <- read.delim(file.path("CSTII_multi_18.txt"))
...
#CSTIII multi Plot
CSTIII <- read.delim(file.path("CSTIII_multi_18.txt"))
...
#CSTIVA multi Plot
CSTIVA <- read.delim(file.path("CSTIVA_multi_18.txt"))
...
#CSTIVC multi Plot
CSTIVC<- read.delim(file.path("CSTIVC_multi_18.txt"))
...
#CSTIVD multi Plot
CSTIVD<- read.delim(file.path("CSTIVD_multi_18.txt"))
