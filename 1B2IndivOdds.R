...
mylogit <- glm(formula = Nugent.score ~ Shannon.s.Diversity, data=total, family = poisson(link = "log"))
mylogit <- glm(formula = Nugent.score ~ Amsels.cat, data=total, family = poisson(link = "log"))
mylogit <- glm(formula = Nugent.score.cat ~ Age.cat, data=total, family = binomial(link = "logit"))
mylogit <- glm(formula = Nugent.score.cat ~ BMI.cat, data=total, family = poisson(link = "log"))
...
mylogit <- glm(formula = Nugent.score.cat ~ Current.or.chronic.conditions...y.1..n.0., data=total, family = poisson(link = "log"))
