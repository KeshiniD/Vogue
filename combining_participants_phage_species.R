...
###############################
#Vogue1A_DNA
vogueA_52 <- read.csv(file="DNA_A_52.phagecol4_ncbi_condensed.csv")
vogueA_52 <- dplyr::rename(vogueA_52, Vogue1A.01.52 = a, Var1 = VALUE)

vogueA_59 <- read.csv(file="DNA_A_59.phagecol4_ncbi_condensed.csv")
vogueA_59 <- dplyr::rename(vogueA_59, Vogue1A.01.59 = a, Var1 = VALUE)

vogueA_61 <- read.csv(file="DNA_A_61.phagecol4_ncbi_condensed.csv")
vogueA_61$VALUE <- NULL
vogueA_61 <- dplyr::rename(vogueA_61, Vogue1A.01.61 = Freq)

vogueA_62 <- read.csv(file="DNA_A_62.phagecol4_ncbi_condensed.csv")
vogueA_62$VALUE <- NULL
vogueA_62 <- dplyr::rename(vogueA_62, Vogue1A.01.62 = Freq)

vogueA_64 <- read.csv(file="DNA_A_64.phagecol4_ncbi_condensed.csv")
...
vogueA_71 <- read.csv(file="DNA_A_71.phagecol4_ncbi_condensed.csv")
...
vogueA_75 <- read.csv(file="DNA_A_75.phagecol4_ncbi_condensed.csv")
vogueA_75$VALUE <- NULL
vogueA_75 <- dplyr::rename(vogueA_75, Vogue1A.01.75 = Freq)

vogueA_76 <- read.csv(file="DNA_A_76.phagecol4_ncbi_condensed.csv")
vogueA_76$VALUE <- NULL
vogueA_76 <- dplyr::rename(vogueA_76, Vogue1A.01.76 = Freq)

# vogueA_77

vogueA_78 <- read.csv(file="DNA_A_78.phagecol4_ncbi_condensed.csv")
vogueA_78$VALUE <- NULL
vogueA_78 <- dplyr::rename(vogueA_78, Vogue1A.01.78 = Freq)

vogueA_81 <- read.csv(file="DNA_A_81.phagecol4_ncbi_condensed.csv")
vogueA_81$VALUE <- NULL
vogueA_81 <- dplyr::rename(vogueA_81, Vogue1A.01.81 = Freq)

vogueA_84 <- read.csv(file="DNA_A_84.phagecol4_ncbi_condensed.csv")
vogueA_84 <- dplyr::rename(vogueA_84, Vogue1A.01.84 = a, Var1 = VALUE)

vogueA_85 <- read.csv(file="DNA_A_85.phagecol4_ncbi_condensed.csv")
vogueA_85$VALUE <- NULL
vogueA_85 <- dplyr::rename(vogueA_85, Vogue1A.01.85 = Freq)

vogueA_92 <- read.csv(file="DNA_A_92.phagecol4_ncbi_condensed.csv")
...
vogueA_106 <- read.csv(file="DNA_A_106.phagecol4_ncbi_condensed.csv")
...
#######################################################################
#1B2_DNA
vogue1B2_06 <- read.csv(file="DNA_1B2_06.phagecol4_ncbi_condensed.csv")
vogue1B2_06$VALUE <- NULL
vogue1B2_06 <- dplyr::rename(vogue1B2_06, Vogue1B2.01.06 = Freq)

vogue1B2_07 <- read.csv(file="DNA_1B2_07.phagecol4_ncbi_condensed.csv")
vogue1B2_07 <- dplyr::rename(vogue1B2_07, Vogue1B2.01.07 = a, Var1 = VALUE)

vogue1B2_08 <- read.csv(file="DNA_1B2_08.phagecol4_ncbi_condensed.csv")
vogue1B2_08 <- dplyr::rename(vogue1B2_08, Vogue1B2.01.08 = a, Var1 = VALUE)

vogue1B2_09 <- read.csv(file="DNA_1B2_09.phagecol4_ncbi_condensed.csv")
vogue1B2_09$VALUE <- NULL
vogue1B2_09 <- dplyr::rename(vogue1B2_09, Vogue1B2.01.09 = Freq)

vogue1B2_10 <- read.csv(file="DNA_1B2_10.phagecol4_ncbi_condensed.csv")
vogue1B2_10 <- dplyr::rename(vogue1B2_10, Vogue1B2.01.10 = a, Var1 = VALUE)

vogue1B2_11 <- read.csv(file="DNA_1B2_11.phagecol4_ncbi_condensed.csv")
vogue1B2_11$VALUE <- NULL
vogue1B2_11 <- dplyr::rename(vogue1B2_11, Vogue1B2.01.11 = Freq)

vogue1B2_12 <- read.csv(file="DNA_1B2_12.phagecol4_ncbi_condensed.csv")
vogue1B2_12$VALUE <- NULL
vogue1B2_12 <- dplyr::rename(vogue1B2_12, Vogue1B2.01.12 = Freq)

vogue1B2_15 <- read.csv(file="DNA_1B2_15.phagecol4_ncbi_condensed.csv")
...
vogue1A_61 <- read.csv(file="Vogue1A_61_RNA.phagecol4_ncbi_condensed.csv")
vogue1A_61 <- dplyr::rename(vogue1A_61, Vogue1A.01.61 = a, Var1 = VALUE)

vogue1A_106 <- read.csv(file="Vogue1A_106_RNA.phagecol4_ncbi_condensed.csv")
vogue1A_106$VALUE <- NULL
vogue1A_106 <- dplyr::rename(vogue1A_106, Vogue1A.01.106 = Freq)

vogue1B2_11 <- read.csv(file="Vogue1B2_11_RNA.phagecol4_ncbi_condensed.csv")
