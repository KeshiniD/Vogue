...
###############################
#Vogue1A_DNA
vogueA_52 <- read.csv(file="Vogue1A_52_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_52$VALUE <- NULL
vogueA_52 <- dplyr::rename(vogueA_52, Vogue1A.01.52 = Freq)

vogueA_59 <- read.csv(file="Vogue1A_59_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_59$VALUE <- NULL
vogueA_59 <- dplyr::rename(vogueA_59, Vogue1A.01.59 = Freq)

vogueA_61 <- read.csv(file="Vogue1A_61_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_61$VALUE <- NULL
vogueA_61 <- dplyr::rename(vogueA_61, Vogue1A.01.61 = Freq)

vogueA_62 <- read.csv(file="Vogue1A_62_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_62$VALUE <- NULL
vogueA_62 <- dplyr::rename(vogueA_62, Vogue1A.01.62 = Freq)

vogueA_64 <- read.csv(file="Vogue1A_64_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_64$VALUE <- NULL
vogueA_64 <- dplyr::rename(vogueA_64, Vogue1A.01.64 = Freq)

vogueA_65 <- read.csv(file="Vogue1A_65_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_65$VALUE <- NULL
vogueA_65 <- dplyr::rename(vogueA_65, Vogue1A.01.65 = Freq)

vogueA_68 <- read.csv(file="Vogue1A_68_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_68$VALUE <- NULL
vogueA_68 <- dplyr::rename(vogueA_68, Vogue1A.01.68 = Freq)

vogueA_69 <- read.csv(file="Vogue1A_69_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_69$VALUE <- NULL
vogueA_69 <- dplyr::rename(vogueA_69, Vogue1A.01.69 = Freq)

vogueA_70 <- read.csv(file="Vogue1A_70_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_70$VALUE <- NULL
vogueA_70 <- dplyr::rename(vogueA_70, Vogue1A.01.70 = Freq)

vogueA_71 <- read.csv(file="Vogue1A_71_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_71$VALUE <- NULL
vogueA_71 <- dplyr::rename(vogueA_71, Vogue1A.01.71 = Freq)

vogueA_74 <- read.csv(file="Vogue1A_74_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_74$VALUE <- NULL
vogueA_74 <- dplyr::rename(vogueA_74, Vogue1A.01.74 = Freq)

vogueA_75 <- read.csv(file="Vogue1A_75_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_75$VALUE <- NULL
vogueA_75 <- dplyr::rename(vogueA_75, Vogue1A.01.75 = Freq)

vogueA_76 <- read.csv(file="Vogue1A_76_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_76$VALUE <- NULL
vogueA_76 <- dplyr::rename(vogueA_76, Vogue1A.01.76 = Freq)

vogueA_77 <- read.csv(file="Vogue1A_77_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_77$VALUE <- NULL
vogueA_77 <- dplyr::rename(vogueA_77, Vogue1A.01.77 = Freq)

vogueA_78 <- read.csv(file="Vogue1A_78_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_78$VALUE <- NULL
vogueA_78 <- dplyr::rename(vogueA_78, Vogue1A.01.78 = Freq)

vogueA_81 <- read.csv(file="Vogue1A_81_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_81$VALUE <- NULL
vogueA_81 <- dplyr::rename(vogueA_81, Vogue1A.01.81 = Freq)

vogueA_84 <- read.csv(file="Vogue1A_84_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_84$VALUE <- NULL
vogueA_84 <- dplyr::rename(vogueA_84, Vogue1A.01.84 = Freq)

vogueA_85 <- read.csv(file="Vogue1A_85_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_85$VALUE <- NULL
vogueA_85 <- dplyr::rename(vogueA_85, Vogue1A.01.85 = Freq)

vogueA_92 <- read.csv(file="Vogue1A_92_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_92$VALUE <- NULL
vogueA_92 <- dplyr::rename(vogueA_92, Vogue1A.01.92 = Freq)

vogueA_101 <- read.csv(file="Vogue1A_101_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueA_101$VALUE <- NULL
vogueA_101 <- dplyr::rename(vogueA_101, Vogue1A.01.101 = Freq)

vogueA_106 <- read.csv(file="Vogue1A_106_DNA_1.viralcol4_ncbi_family_condensed.csv")
...
#################################################################
#Vogue1B_DNA
vogueB_01 <- read.csv(file="Vogue1B_01_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_01$VALUE <- NULL
vogueB_01 <- dplyr::rename(vogueB_01, Vogue1B.01.01 = Freq)

vogueB_03 <- read.csv(file="Vogue1B_03_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_03$VALUE <- NULL
vogueB_03 <- dplyr::rename(vogueB_03, Vogue1B.01.03 = Freq)

vogueB_04 <- read.csv(file="Vogue1B_04_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_04$VALUE <- NULL
vogueB_04 <- dplyr::rename(vogueB_04, Vogue1B.01.04 = Freq)

vogueB_05 <- read.csv(file="Vogue1B_05_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_05$VALUE <- NULL
vogueB_05 <- dplyr::rename(vogueB_05, Vogue1B.01.05 = Freq)

vogueB_06 <- read.csv(file="Vogue1B_06_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_06$VALUE <- NULL
vogueB_06 <- dplyr::rename(vogueB_06, Vogue1B.01.06 = Freq)

vogueB_08 <- read.csv(file="Vogue1B_08_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_08$VALUE <- NULL
vogueB_08 <- dplyr::rename(vogueB_08, Vogue1B.01.08 = Freq)

vogueB_09 <- read.csv(file="Vogue1B_09_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_09$VALUE <- NULL
vogueB_09 <- dplyr::rename(vogueB_09, Vogue1B.01.09 = Freq)

vogueB_11 <- read.csv(file="Vogue1B_11_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_11$VALUE <- NULL
vogueB_11 <- dplyr::rename(vogueB_11, Vogue1B.01.11 = Freq)

vogueB_12 <- read.csv(file="Vogue1B_12_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_12$VALUE <- NULL
vogueB_12 <- dplyr::rename(vogueB_12, Vogue1B.01.12 = Freq)

vogueB_13 <- read.csv(file="Vogue1B_13_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_13$VALUE <- NULL
vogueB_13 <- dplyr::rename(vogueB_13, Vogue1B.01.13 = Freq)

vogueB_15 <- read.csv(file="Vogue1B_15_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_15$VALUE <- NULL
vogueB_15 <- dplyr::rename(vogueB_15, Vogue1B.01.15 = Freq)

vogueB_17 <- read.csv(file="Vogue1B_17_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_17$VALUE <- NULL
vogueB_17 <- dplyr::rename(vogueB_17, Vogue1B.01.17 = Freq)

vogueB_21 <- read.csv(file="Vogue1B_21_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_21$VALUE <- NULL
vogueB_21 <- dplyr::rename(vogueB_21, Vogue1B.01.21 = Freq)

vogueB_26 <- read.csv(file="Vogue1B_26_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_26$VALUE <- NULL
vogueB_26 <- dplyr::rename(vogueB_26, Vogue1B.01.26 = Freq)

vogueB_27 <- read.csv(file="Vogue1B_27_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_27$VALUE <- NULL
vogueB_27 <- dplyr::rename(vogueB_27, Vogue1B.01.27 = Freq)

vogueB_32 <- read.csv(file="Vogue1B_32_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_32$VALUE <- NULL
vogueB_32 <- dplyr::rename(vogueB_32, Vogue1B.01.32 = Freq)

vogueB_34 <- read.csv(file="Vogue1B_34_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_34$VALUE <- NULL
vogueB_34 <- dplyr::rename(vogueB_34, Vogue1B.01.34 = Freq)

vogueB_36 <- read.csv(file="Vogue1B_36_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_36$VALUE <- NULL
vogueB_36 <- dplyr::rename(vogueB_36, Vogue1B.01.36 = Freq)

vogueB_37 <- read.csv(file="Vogue1B_37_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_37$VALUE <- NULL
vogueB_37 <- dplyr::rename(vogueB_37, Vogue1B.01.37 = Freq)

vogueB_38 <- read.csv(file="Vogue1B_38_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_38$VALUE <- NULL
vogueB_38 <- dplyr::rename(vogueB_38, Vogue1B.01.38 = Freq)

vogueB_40 <- read.csv(file="Vogue1B_40_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_40$VALUE <- NULL
vogueB_40 <- dplyr::rename(vogueB_40, Vogue1B.01.40 = Freq)

vogueB_43 <- read.csv(file="Vogue1B_43_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_43$VALUE <- NULL
vogueB_43 <- dplyr::rename(vogueB_43, Vogue1B.01.43 = Freq)

vogueB_48 <- read.csv(file="Vogue1B_48_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_48$VALUE <- NULL
vogueB_48 <- dplyr::rename(vogueB_48, Vogue1B.01.48 = Freq)

vogueB_51 <- read.csv(file="Vogue1B_51_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogueB_51$VALUE <- NULL
vogueB_51 <- dplyr::rename(vogueB_51, Vogue1B.01.51 = Freq)

vogueB_52 <- read.csv(file="Vogue1B_52_DNA_1.viralcol4_ncbi_family_condensed.csv")
...
#######################################################################
#1B2_DNA
vogue1B2_06 <- read.csv(file="Vogue1B2_06_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_06$VALUE <- NULL
vogue1B2_06 <- dplyr::rename(vogue1B2_06, Vogue1B2.01.06 = Freq)

vogue1B2_07 <- read.csv(file="Vogue1B2_07_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_07$VALUE <- NULL
vogue1B2_07 <- dplyr::rename(vogue1B2_07, Vogue1B2.01.07 = Freq)

vogue1B2_08 <- read.csv(file="Vogue1B2_08_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_08$VALUE <- NULL
vogue1B2_08 <- dplyr::rename(vogue1B2_08, Vogue1B2.01.08 = Freq)

vogue1B2_09 <- read.csv(file="Vogue1B2_09_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_09$VALUE <- NULL
vogue1B2_09 <- dplyr::rename(vogue1B2_09, Vogue1B2.01.09 = Freq)

vogue1B2_10 <- read.csv(file="Vogue1B2_10_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_10$VALUE <- NULL
vogue1B2_10 <- dplyr::rename(vogue1B2_10, Vogue1B2.01.10 = Freq)

vogue1B2_11 <- read.csv(file="Vogue1B2_11_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_11$VALUE <- NULL
vogue1B2_11 <- dplyr::rename(vogue1B2_11, Vogue1B2.01.11 = Freq)

vogue1B2_12 <- read.csv(file="Vogue1B2_12_DNA_1.viralcol4_ncbi_family_condensed.csv")
vogue1B2_12$VALUE <- NULL
vogue1B2_12 <- dplyr::rename(vogue1B2_12, Vogue1B2.01.12 = Freq)

vogue1B2_15 <- read.csv(file="Vogue1B2_15_DNA_1.viralcol4_ncbi_family_condensed.csv")
...
# write.csv(a, "Viral_family_DNA_1A.csv")
# write.csv(b, "Viral__family_DNA_1B.csv")
# write.csv(b2, "Viral_family_DNA_1B2.csv")
