...
#write to file
# write.csv(everyone3, "virus_order_all.csv")
# write.csv(vogueA3, "virus_order_1A.csv")
# write.csv(vogueB3, "virus_order_1B.csv")
# write.csv(vogue1b2b, "virus_order_1B2.csv")
