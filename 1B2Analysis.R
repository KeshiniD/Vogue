...
jColors <- c('blue', 'cornflowerblue', 'darkgoldenrod1', 'peachpuff3',
             'mediumorchid2', 'turquoise3', 'wheat4', 'slategray2', 'aquamarine2', 
             'aquamarine3', 'aquamarine4', 'deepskyblue3', 'deepskyblue4',
