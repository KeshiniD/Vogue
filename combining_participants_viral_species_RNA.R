...
#######################################################################
#1B2_DNA
vogue1B2_06 <- read.csv(file="Vogue1B2_06_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_06$VALUE <- NULL
vogue1B2_06 <- dplyr::rename(vogue1B2_06, Vogue1B2.01.06 = Freq)

vogue1B2_07 <- read.csv(file="Vogue1B2_07_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_07$VALUE <- NULL
vogue1B2_07 <- dplyr::rename(vogue1B2_07, Vogue1B2.01.07 = Freq)

vogue1B2_08 <- read.csv(file="Vogue1B2_08_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_08$VALUE <- NULL
vogue1B2_08 <- dplyr::rename(vogue1B2_08, Vogue1B2.01.08 = Freq)

vogue1B2_09 <- read.csv(file="Vogue1B2_09_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_09$VALUE <- NULL
vogue1B2_09 <- dplyr::rename(vogue1B2_09, Vogue1B2.01.09 = Freq)

vogue1B2_10 <- read.csv(file="Vogue1B2_10_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_10$VALUE <- NULL
vogue1B2_10 <- dplyr::rename(vogue1B2_10, Vogue1B2.01.10 = Freq)

vogue1B2_11 <- read.csv(file="Vogue1B2_11_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_11$VALUE <- NULL
vogue1B2_11 <- dplyr::rename(vogue1B2_11, Vogue1B2.01.11 = Freq)

vogue1B2_12 <- read.csv(file="Vogue1B2_12_RNA.viralcol4_ncbi_condensed.csv")
vogue1B2_12$VALUE <- NULL
vogue1B2_12 <- dplyr::rename(vogue1B2_12, Vogue1B2.01.12 = Freq)

vogue1B2_15 <- read.csv(file="Vogue1B2_15_RNA.viralcol4_ncbi_condensed.csv")
