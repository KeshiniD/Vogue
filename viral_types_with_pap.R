...
#ref manual
vref <- read.csv("virome_recode_type_pap.csv", header=FALSE, stringsAsFactors = FALSE)
...
#write to file
# write.csv(everyone3, "virus_types_with_pap_all.csv")
# write.csv(vogueA3, "virus_types_with_pap_1A.csv")
# write.csv(vogueB3, "virus_types_with_pap_1B.csv")
# write.csv(vogue1b2b, "virus_types_with_pap_1B2.csv")

#plot
#call data
everyone <- read.csv("virus_types_with_pap_all.csv")
vogueA <- read.csv("virus_types_with_pap_1A.csv")
vogueB <- read.csv("virus_types_with_pap_1B.csv")
vogue1b2 <- read.csv("virus_types_with_pap_1B2.csv")
...
#bac counts
data <-
  gather(everyone2, key = 'Viral_Groups', value = 'Counts', -Participants)
...
jColors <- c('purple', 'green', 'blue', 'orange', 'red', 'yellow', 'turquoise')
